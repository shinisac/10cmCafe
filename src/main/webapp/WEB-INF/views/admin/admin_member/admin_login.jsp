...
<div id="header-wrapper">
		<div id="header" class="container">
			<div id="logo">
				...
				<h1><a href="admin_index.do">10cm CAFE</a></h1>
				<h2><a href="#">관리자 로그인</a></h2>
			</div>
		</div>
	</div>
	
			<form name="adminlogin" action="admin_index.do" class="signUp" id="signupForm" method="POST">
   			<h1 class="signUpTitle">LOGIN</h1>
        			<input type="text" class="signUpInput" name="admin_member_id" placeholder="아이디" autofocus required value=${cookie.ck.value } >
         			<input type="password" class="signUpInput" name="admin_member_pwd" placeholder="비밀번호" required>
