...
#main tr:hover{
 ...
 #update{
    ...
    function drawChart() {
      ...
      function show(){
  		var salesSearcha=document.adminsalesSearch.startdate.value;
  		var salesSearchb=document.adminsalesSearch.enddate.value;
  		if(salesSearcha==""){
  			alert('날짜를 입력해주세요.');
  			return;
...
<div class="wrapper">
	...
	<article>
		...
		<form name="adminsalesSearch" action="AdminSales.do" method="POST">
		...
		<input type="hidden" name="cp" value="${cp }">
			...
			<tfoot>
					...
					<c:if test="${empty list }">
						<td colspan="5" align="center">
							<a href="AdminSales.do?cp=1&shop_idx=${shop_idx}&shop_name=${shop_name}">메인으로</a>
						</td>
					</c:if>	
