...
<div class="menu-category">
	<div id="Burgers" class="menu-category-title">
		<div class="bg-image" style="background-image:url('img/menu/${cate.category_img}');"><img alt="" src="img/menu/${cate.category_img}" style="display: none;">
		</div>
						...
						<div class="row align-items-center mt-4">
							...
							<div class="col-sm-6 text-sm-right mt-2 mt-sm-0">
								<button class="btn btn-outline-secondary btn-sm"
									data-target="#productModal" data-toggle="modal" onclick="menushow('${menulist.menu_idx}')">
									<span>Order</span>
								</button>
							</div>
						</div>
