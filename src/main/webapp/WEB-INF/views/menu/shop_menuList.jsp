...
<script>
   ...
   function show(idx){//요청함수
      ...
      sendRequest('category_menu.do',param,showResult,'GET');
   }
                ...
                <div class="col-md-2">
                    <a href="javascript:;" class="module module-cart right" data-toggle="panel-cart">
                        <span class="cart-icon">
                            ...
                            <span class="notification" id="cartcount">${cartcnt}</span>
                        </span>
                        <span class="cart-value" id="cartprice"><fmt:formatNumber value="${cartprice}" pattern="#,##0" /></span>
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 push-lg-4">
                        <h1 class="mb-0"><b>Menu</b></h1>
                        <h4 class="text-muted mb-0">${shop_name }</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row no-gutters">
                    <div class="col-md-3">
                        ...
                        <c:forEach var="cate" items="${shopcategory}">
                           <li><A href="javascript:;" onclick="show('${cate.category_idx}')">${cate.category_name}</A></li>
                        </c:forEach>
                            </ul>
                        </nav>
                    </div>
                    <div class="col-md-9" id="menuList">
                        ...
                        <div id="Burgers" class="menu-category">
                            <div class="menu-category-title">
                                <div class="bg-image"><img src="img/menu/coffee.jpg" alt=""></div>
                                    ...
                                    <div class="col-lg-4 col-6">
                                        ...
                                        <div class="menu-item menu-grid-item">
                                            ...
                                            <div class="row align-items-center mt-4">
                                                ...
                                                <div class="col-sm-6 text-sm-right mt-2 mt-sm-0"><button class="btn btn-outline-secondary btn-sm" data-target="#productModal" data-toggle="modal" onclick="menushow('${list.menu_idx}')"><span>Order</span></button></div>
                                            </div>
                                        </div>
                                    </div>
                                 </c:forEach>   
            ...
            <div class="panel-cart-content" id="carts">
                   ...
                   <form id="${i}">
                       ...
                       <tr>
                           ...
                           <td><a href="javascript:;" onclick="cartcount();mamount('${i}');totalprice();">-</a> <input type="text" class="intext" name="cartamount" size="1"id="amount" value="${cartlist.order_menu_amount}" readonly="readonly"> <a href="javascript:;" onClick="cartcount();pamount('${i}');totalprice();">+</a></td>
                           <td class="actions">      
