...
<table class="table">
   ...
   <tbody>
      ...
      <tr>
         ...
         <td><fmt:formatDate value="${dto.review_date }" type="DATE" pattern="yyyy/MM/dd HH:mm:ss" />
         </td>
         ...
         <c:if test="${sessionScope.id eq dto.review_writer }">
            ...
            <tr>
         <td colspan="2" align="center"><div id="div2_${i}" style="display: none"><img src="img/${dto.review_img }" alt="ㅇㅇㅇ"></div></td>
