...
public class ShopDTO {
	...
	private int shop_lat;
	private int shop_lng;
	...
	public int getShop_lat() {
		return shop_lat;
	}

	public void setShop_lat(int shop_lat) {
		this.shop_lat = shop_lat;
	}

	public int getShop_lng() {
		return shop_lng;
	}

	public void setShop_lng(int shop_lng) {
		this.shop_lng = shop_lng;
	}
}
